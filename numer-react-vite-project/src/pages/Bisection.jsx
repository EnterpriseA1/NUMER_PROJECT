        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center border rounded p-4 mt-5 min-h-screen">
                ...
                <div className="flex flex-col justify-center items-center mt-4 w-full overflow-x-auto">
                    <table className="table-auto w-full text-center border-collapse border border-gray-800">
                        <thead>
                        ...
                        <tbody>
                            {iterations.map((element, index) => (
                                <tr key={index} className="bg-gray-100">
                                    ...
                                    <td className="border px-4 py-2">{element.Xl}</td>
                                    <td className="border px-4 py-2">{element.Xm}</td>
                                    <td className="border px-4 py-2">{element.Xr}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
